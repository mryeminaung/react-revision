...
const Modal = ({ onClose, open }) => {
    ...
    return ReactDOM.createPortal(
        <div
            id="center-center-modal"
            tabIndex={-1}
            className="bg-slate-500/50 overflow-y-auto  fixed  top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 min-h-screen max-h-full"
            onClick={onClose}
        >
                ...
                >
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button
                            ...
                            data-modal-hide="center-center-modal"
                            onClick={onClose}
                        >
                            <svg
                                className="w-3 h-3"
